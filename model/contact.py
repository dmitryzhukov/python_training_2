...
class Contact:
    ...
    def __init__(self, firstname=None, middlename=None, lastname=None, nickname=None, title=None, company=None, address_company=None, home_phone=None,
                 ...
                 byear=None, aday=None, amonth=None, ayear=None, address=None, home=None, notes=None, id=None):
    ...
    def __eq__(self, other) -> bool:
        return (self.id is not None or other.id is not None or self.id == other.id) and self.firstname == other.firstname and self.lastname == other.lastname

...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        wd.find_element_by_name("firstname").send_keys("Test First name")
        wd.find_element_by_name("middlename").clear()
        wd.find_element_by_name("middlename").send_keys("Test Middle name")
        wd.find_element_by_name("lastname").clear()
        wd.find_element_by_name("lastname").send_keys("Test Last name")
        ...
        wd.find_element_by_name("home").send_keys("Test Home")
        wd.find_element_by_name("mobile").click()
        wd.find_element_by_name("mobile").clear()
        wd.find_element_by_name("mobile").send_keys("Test Mobile")
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys("Test Work")
        wd.find_element_by_name("fax").click()
        wd.find_element_by_name("fax").clear()
        wd.find_element_by_name("fax").send_keys("Test Fax")
        wd.find_element_by_name("email").click()
        wd.find_element_by_name("email").clear()
        wd.find_element_by_name("email").send_keys("Test@mail.ru")
        wd.find_element_by_name("email2").click()
        wd.find_element_by_name("email2").clear()
        wd.find_element_by_name("email2").send_keys("Test2@mail.ru")
        wd.find_element_by_name("email3").click()
        wd.find_element_by_name("email3").clear()
        wd.find_element_by_name("email3").send_keys("Test3@mail.ru")
        ...
        wd.find_element_by_xpath("//div[@id='content']/form/select[3]/option[33]").click()
        ...
        Select(wd.find_element_by_name("new_group")).select_by_visible_text("Test group")
        wd.find_element_by_xpath("//div[@id='content']/form/select[5]/option[3]").click()
        wd.find_element_by_name("address2").click()
        wd.find_element_by_name("address2").clear()
        wd.find_element_by_name("address2").send_keys("Test Addewss")
        wd.find_element_by_name("phone2").click()
        wd.find_element_by_name("phone2").clear()
        wd.find_element_by_name("phone2").send_keys("Test Home")

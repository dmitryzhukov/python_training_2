...
def test_add_contact(app):
    ...
    app.create_contact(Contact(firstname="Test First name", middlename="Test Middle name", lastname="Test Last name",
                                ...
                                group="Test group", address="Test Address", home="Test Home",
                                notes="Test Notes"))
    app.open_home_page()
    app.logout()
